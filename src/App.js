    ...
    <div className="container">
      ...
      <div className="row">
            ...
            <div className="list-group">
              ...
              {jwtToken !== "" &&
                <>
                  ...
                  <Link to="/manage-catalouge" className="list-group-item list-group-item-action">Manage Catalouge</Link>
        ...
        <div className="col-md-10">
          ...
          <Outlet context={{
            jwtToken, setJwtToken, setAlertClassName, setAlertMessage, toogleRefresh,
          }}/>
        </div>
      </div> 
    </div>
