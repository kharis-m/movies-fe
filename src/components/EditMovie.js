...
const EditMovie = () => {
    ...
    const mpaaOptions = [
        {id: "G", value: "G - General Audiences"},
        {id: "PG", value: "PG - Parental Guidance Suggested"},
        {id: "PG-13", value: "PG-13 - Parents Strongly Cautioned"},
        {id: "R", value: "R - Restricted"},
        {id: "NC17", value: "NC17 - Adults Only"},
    ]
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <p>Upload gambar untuk poster</p>
                ...
                {movie.id > 0 && (
                <a href="#!" className="btn btn-danger ms-2" onClick={confrimDelete}>Delete Movie</a>
                )}
            </form>
        </div>
    )}
